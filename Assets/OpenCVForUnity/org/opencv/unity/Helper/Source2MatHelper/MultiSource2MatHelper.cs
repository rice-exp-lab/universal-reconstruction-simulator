...
#endif
        [SerializeField, Tooltip("Select the source to mat helper class name. If CustomSource2MatHelper is selected, only the UnityEvent inspector is overridden for the custom helper class component.")]
...
#endif
        [SerializeField, Tooltip("Set the custom class <ISource2MatHelper> component.")]
