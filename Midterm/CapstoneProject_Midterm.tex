...
\begin{figure}[ht] 
\centering 
\begin{subfigure}[b]{0.3\textwidth} \includegraphics[width=\textwidth]{images/lab_out.png} \caption{Lab building} 
\end{subfigure} 
\hfill 
\begin{subfigure}[b]{0.3\textwidth} \includegraphics[width=\textwidth]{images/lab_in_top2.png} \caption{Multiple camera setup} 
\end{subfigure} 
