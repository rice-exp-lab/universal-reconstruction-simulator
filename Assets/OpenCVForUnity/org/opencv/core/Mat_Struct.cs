...
namespace OpenCVForUnity.CoreModule
{
    public partial class Mat : CleanableMat
    {
        ...
        /// </param>
        public Mat(in Vec2d size, int type) : base(IntPtr.Zero)
        {

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__DDI(size.Item1, size.Item2, type));
        ...
        /// </param>
        public Mat(int rows, int cols, int type, in Vec4d s) : base(IntPtr.Zero)
        {

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__IIIDDDD(rows, cols, type, s.Item1, s.Item2, s.Item3, s.Item4));
        ...
        /// Mat::operator=(const Scalar&amp; value) .
        /// </param>
        public Mat(in Vec2d size, int type, in Vec4d s) : base(IntPtr.Zero)
        {

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__DDIDDDD(size.Item1, size.Item2, type, s.Item1, s.Item2, s.Item3, s.Item4));
        ...
        /// Mat::operator=(const Scalar&amp; value) .
        /// </param>
        public Mat(int[] sizes, int type, in Vec4d s) : base(IntPtr.Zero)
        {

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__I_3IIDDDD(sizes.Length, sizes, sizes.Length, type, s.Item1, s.Item2, s.Item3, s.Item4));
        ...
        /// </param>
        public Mat(Mat m, in Vec2i rowRange, in Vec2i colRange) : base(IntPtr.Zero)
        {
            if (m != null)
                m.ThrowIfDisposed();

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__JIIII(m.nativeObj, rowRange.Item1, rowRange.Item2, colRange.Item1, colRange.Item2));
        ...
        /// end is exclusive.Use Range::all() to take all the rows.
        /// </param>
        public Mat(Mat m, in Vec2i rowRange) : base(IntPtr.Zero)
        {
            if (m != null)
                m.ThrowIfDisposed();

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__JII(m.nativeObj, rowRange.Item1, rowRange.Item2));
        ...
        /// </param>
        public Mat(Mat m, in Vec2i[] ranges) : base(IntPtr.Zero)
        {
            if (m != null)
                m.ThrowIfDisposed();
            ...
            {
                rangesArray[i * 2] = ranges[i].Item1;
                rangesArray[i * 2 + 1] = ranges[i].Item2;
            }
        ...
        /// Region of interest.
        /// </param>
        public Mat(Mat m, in Vec4i roi) : base(IntPtr.Zero)
        {
            if (m != null)
                m.ThrowIfDisposed();

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__JIIII(m.nativeObj, roi.Item2, roi.Item2 + roi.Item4, roi.Item1, roi.Item1 + roi.Item3));
        ...
        /// </param>
        public Mat(in Vec2d size, int type, IntPtr data, long step = AUTO_STEP) : base(IntPtr.Zero)
        {

            nativeObj = DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1Mat__DDIVL(size.Item1, size.Item2, type, data, step));
        ...
        /// </param>
        public Mat colRange(in Vec2i r)
        {
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1colRange(nativeObj, r.Item1, r.Item2)));
        ...
        /// New matrix type.
        /// </param>
        public void create(in Vec2d size, int type)
        {
            ThrowIfDisposed();

            core_Mat_n_1create__JDDI(nativeObj, size.Item1, size.Item2, type);
        ...
        /// Created matrix type.
        /// </param>
        public static Mat eye(in Vec2d size, int type)
        {

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1eye__DDI(size.Item1, size.Item2, type)));
        ...
        /// </param>
        public void locateROI(out Vec2d wholeSize, out Vec2d ofs)
        {
            ThrowIfDisposed();
            ...
            {
                wholeSize.Item1 = wholeSize_out[0];
                wholeSize.Item2 = wholeSize_out[1];
            }
        ...
        /// Created matrix type.
        /// </param>
        public static Mat ones(in Vec2d size, int type)
        {

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1ones__DDI(size.Item1, size.Item2, type)));
        ...
        /// Range structure containing both the start and the end indices.
        /// </param>
        public Mat rowRange(in Vec2i r)
        {
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1rowRange(nativeObj, r.Item1, r.Item2)));
        ...
        /// </param>
        public Mat setTo(in Vec4d s)
        {
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1setTo__JDDDD(nativeObj, s.Item1, s.Item2, s.Item3, s.Item4)));
        ...
        /// </param>
        public Mat setTo(in Vec4d value, Mat mask)
        {
            if (mask != null)
                mask.ThrowIfDisposed();
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1setTo__JDDDDJ(nativeObj, value.Item1, value.Item2, value.Item3, value.Item4, mask.nativeObj)));
        ...
        public Vec2d sizeAsVec2d()
        {
            ...
            return new Vec2d(tmpArray[0], tmpArray[1]);
        ...
        /// </param>
        public Mat submat(in Vec2i rowRange, in Vec2i colRange)
        {
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1submat_1rr(nativeObj, rowRange.Item1, rowRange.Item2, colRange.Item1, colRange.Item2)));
        ...
        /// </param>
        public Mat submat(in Vec2i[] ranges)
        {
            ThrowIfDisposed();
        ...
        /// </param>
        public Mat submat(in Vec4i roi)
        {
            ThrowIfDisposed();

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1submat(nativeObj, roi.Item1, roi.Item2, roi.Item3, roi.Item4)));
        ...
        /// Created matrix type.
        /// </param>
        public static Mat zeros(in Vec2d size, int type)
        {

            return new Mat(DisposableObject.ThrowIfNullIntPtr(core_Mat_n_1zeros__DDI(size.Item1, size.Item2, type)));
